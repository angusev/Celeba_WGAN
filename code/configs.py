...
class Parser:
    def __init__(self):
        ...
        self.paths_parser = self.subparsers.add_parser(
            "paths", help="args for paths to files"
        )
        self.paths_parser.add_argument(
            "--dataset", type=str, default="img_align_celeba"
        )
        self.paths_parser.add_argument("--examples", type=str, default="examples")
        self.paths_parser.add_argument(
            "--attributes", type=str, default="./Anno/list_attr_celeba.txt"
        )

        self.training_configs_parser = self.subparsers.add_parser(
            "training", help="training configurations"
        )
        ...
        self.launch_configs_parser = self.subparsers.add_parser(
            "launch", help="special settings for a launch"
        )
